...
import { isPlatformOwner, isMasterSaaSAdmin } from '../../utils/auth';
...
export const AssinaturaView: React.FC<AssinaturaViewProps> = ({
  ...
  const isSaasAdmin = isMasterSaaSAdmin(currentUser, business);
  ...
  useEffect(() => {
    if (!isSaasAdmin && viewMode !== 'my_plan') {
      setViewMode('my_plan');
    }
  }, [isSaasAdmin, viewMode]);
  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      {/* Banner / Card para Divulgação da Página Pública de Assinaturas (Apenas Super Admin) */}
      {isSaasAdmin && (
